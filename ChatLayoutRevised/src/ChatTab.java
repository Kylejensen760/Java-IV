...
public class ChatTab extends JPanel implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == sendButton) {
			request = messageArea.getText(); // messageArea needs to be seen by this actionPerformed
			out.writeObject(request); //'out' needs to be seen via a connection to ChatMain
			messageArea.setText("");
		}
	}
}